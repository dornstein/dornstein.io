# David Ornstein — Source of Truth Reference Document

> **PURPOSE**: This file is the authoritative factual reference for David's portfolio site.
> It is NOT published or linked from any web page. It exists so that future AI assistants
> (or David himself) can consult it for accurate facts rather than relying on the
> presentation-layer HTML, which may drift over time.
>
> **RULE**: When updating the website, always check facts against this document.
> Only David should add or modify facts here. AI assistants should treat this
> file as read-only ground truth.
>
> **Last updated**: 2026-02-08 — initial creation from David's Professional Career History
> document and earlier career details he provided directly.

---

## Career Timeline (Chronological)

### Sinclair Research Ltd. — 1979–1981
...
#### PC Architecture & CRTS (1987–1989)
...
- **Project**: Internet Publishing Tools
- **Details**: Founded and led a software startup delivering internet publishing tools and software solutions. Developed an object-oriented web programming language with SGML syntax (predating XML). Recruited executive team, secured multiple rounds of angel investment.
...
- **Promoted To**: Chief Technical Officer
- **Project**: Rocket eBook Device & Platform
...
#### Architect, eBooks/Emerging Technologies (1999–2001)
- **Title**: Architect, Emerging Technologies group
...
- **Project**: "Metro" Document Format → XML Paper Specification (XPS)
...
#### Director, Compliance Engineering (2004–2010)
- **Title**: Director, Compliance Engineering, Engineering Excellence
...
- **Reports to**: Senior VP (CVP) Scott Charney
- **Duration**: ~6 years
...
| Fact | Value | Source |
|------|-------|--------|
| Career span | 40+ years (from 1979) | Career history doc |
| Patents | 12+ at Microsoft (document formats & security) + 1 at Timex (bank switching) | Career history doc + timeline |
| Companies founded/co-founded | 3 (Heuristics, Pragmatica, NuvoMedia) | Career history doc |
| NuvoMedia acquisition value | $187M (by Gemstar, 2000) | Career history doc |
| Liquid services coverage | 8,000+ services company-wide | Career history doc |
| S360 KPI scope | 1,200+ repos, ~18,000 services | Career history doc |
| Liquid team size | 20+ person engineering team | Career history doc |
| Liquid team expansion (2018) | 11 new FTE headcount allocated | Career history doc |
| Compliance program budget | $10M+/year | Career history doc |
| OEBF membership | 100+ members | Career history doc |
| CDIF committee | ~30 voting members, 500+ mailing list | Timeline (David-provided) |
| CDIF ER model | 700+ entities and relationships | Timeline (David-provided) |
| FlexWiki adoption | 1,000+ wikis inside Microsoft | Career history doc |
| Pragmatica codebase | ~100,000 lines of C++ | Career history doc |
| Pragmatica customers | ~5,000 | Career history doc |
| Pragmatica team | 10 employees + consultants | Timeline (David-provided) |
| Rocket eBook specs | 22-ounce, ~55,000 pages capacity | Career history doc |
| TwC Chief of Staff duration | ~6 years | Career history doc |
| Sinclair support volume | ~300 customers/month | Timeline (David-provided) |
| Heuristics revenue | ~$50K revenue, ~40% pre-tax profit | Timeline (David-provided) |
| CRTS codebase | 100K+ lines (OS extensions/dev tools for DOS) | Timeline (David-provided) |
| INTERSOLV bi-coastal team | 12 people | Timeline (David-provided) |
| eBookNet.com team | 12 people, cross-organization | Timeline (David-provided) |
...
| Name | Context |
|------|---------|
| Scott Charney | Senior VP / CVP, Trustworthy Computing. David's principal as Chief of Staff. |

---

## Organizations & Products Referenced

| Name | What it is |
|------|-----------|
| Sinclair Research Ltd. | UK computer company; David worked at US operation |
| Heuristics | David's Sinclair technical services company |
| Timex Computer Corp. | US partner of Sinclair; made Timex/Sinclair computers |
| Multimate International Corp. | Word processing software company |
| Access Technology Inc. | Software company; later acquired by DCA |
| INTERSOLV / Sage Software | CASE tool and software company; later merged with Micro Focus |
| Visual Software | Acquired by INTERSOLV (David led tech due diligence) |
| Polytron Corp. | Acquired by INTERSOLV (David led tech due diligence) |
| LongView International | Derivatives trading systems company |
| Pragmatica, Inc. | David's internet publishing tools startup |
| NuvoMedia, Inc. | David co-founded; made the Rocket eBook |
| Gemstar | Acquired NuvoMedia in 2000 for $187M |
| Open eBook Forum (OEBF) | International e-book standards organization |
| Microsoft | David's employer 1999–present |
| Trustworthy Computing (TwC) | Microsoft's central security strategy org |
| SIGMA | Standards, Insights, Governance, Monitoring & Assurance — org under CISO |
| CELA | Microsoft's Corporate, External and Legal Affairs |
| Rocket eBook | One of the first dedicated e-book readers |
| FlexWiki | Wiki engine David built in C#/.NET at Microsoft |
| Excelerator II | OS/2-based CASE tool at INTERSOLV |
| CRTS | 100K+ line set of DOS OS extensions and dev tools David built |
| CDIF | CASE Data Interchange Format standard (ANSI/EIA) |
| APIScan | Compliance tool David developed at Microsoft |
| CheckPoint / CheckPoint Express | Compliance verification tool at Microsoft |
| Liquid | Microsoft's internal continuous security assurance platform |
| CodeQL Central | Scalable code analysis service for security vulnerabilities |
| XPS / Metro | XML Paper Specification document format |
| eBookNet.com | eBook portal launched by NuvoMedia team |
| Open eBook Publication Structure | XML-based eBook content standard (precursor to EPUB) |
...
## Locations (David-confirmed)

| Role | Location |
|------|----------|
| Sinclair Research | Boston, MA |
| Heuristics | Newton, MA |
| Timex Computer | Middlebury, CT |
| Multimate | E. Hartford, CT |
| Access Technology | S. Natick, MA |
| INTERSOLV (early) | Rockville, MD |
| INTERSOLV (later) | San Jose, CA (+ Rockville, MD & Santa Clara, CA) |
| LongView International | Mountain View, CA |

---

## Standards Led or Co-authored

1. **Open eBook Publication Structure** — Co-author of first drafts; President of the Open eBook Forum
2. **CDIF (CASE Data Interchange Format)** — Chairman of ANSI/EIA committee; published first version of standard
3. **Metro / XPS / Open XML** — Architect of document format adopted in Office 2007 and Windows

---

## Quotes (from David's source documents)

- Manager on Liquid: *"Liquid anchors the company-wide continuous SDL... shifting processes to automated coverage"*
- Manager on David's impact: *"incredible impact"* on the security engineering ecosystem
- CISO leadership on architect transition: *"reflects [his] commitment to continuous growth and deep technical expertise"*
